...
public class EncryptDecryptCSV {
	...
	// sample file path
	String inputFile = "src/com/csvdata/csvfiles/normalfile.csv";
	String encryptedFile = "src/com/csvdata/csvfiles/encrupt.csv";
	...
	// sample file path
	String encryptedFile = "src/com/csvdata/csvfiles/encrupt.csv";
	String decryptedFile = "src/com/csvdata/csvfiles/normalfile.csv";
