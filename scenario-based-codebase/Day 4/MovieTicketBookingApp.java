...
public class MovieTicketBookingApp {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("-------------------------------------------------");
            System.out.print("-> Do you want snacks? (Y/N) if yes press 'y': ");
            char snackChoice = kb.next().charAt(0);
            ...
            System.out.print("Next customer? (Y/N) if yes press 'y': ");
